...
Media text was extracted from various announcements here: [https://www.toronto.ca/home/media-room/news-releases-media-advisories/](https://www.toronto.ca/home/media-room/news-releases-media-advisories/)
...
```{r baseplot, fig.height = 3, fig.width = 7.2, dev = "CairoPNG"}
